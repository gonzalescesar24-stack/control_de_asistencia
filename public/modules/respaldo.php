    ...
    <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div class="mt-4 flex gap-3">
            <button
                ...
                class="w-full sm:w-auto inline-flex justify-center items-center gap-2 rounded-lg bg-[#1a3a6b] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#142d54]"
            >
            ...
            <button
                ...
                class="w-full sm:w-auto inline-flex justify-center items-center gap-2 rounded-lg bg-emerald-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-emerald-700"
            >
