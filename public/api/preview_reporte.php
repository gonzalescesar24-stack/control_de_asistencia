...
foreach ($estudiantes as $index => $e) {
    ...
    $html .= '<td class="table-td font-medium text-center text-slate-700">' . e($e['ciclo']) . '-' . e(clean_seccion($e['seccion'])) . '</td>';
    ...
    $mobileHtml .= '<div class="min-w-0"><span class="text-slate-400 block truncate">Periodo - Sec</span><span class="font-semibold text-slate-700 truncate block">' . e($e['ciclo']) . '-' . e(clean_seccion($e['seccion'])) . '</span></div>';
