...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_GET['error'] === 'inactivity') {
        $error = 'Su sesión ha sido cerrada por inactividad prolongada (30 min).';
    } elseif ($_GET['error'] === 'concurrent') {
        $error = 'Su sesión ha sido cerrada porque se inició sesión desde otro dispositivo.';
    }
}
?>
<!doctype html>
    ...
    <div class="w-full max-w-md">
        ...
        <form method="post" class="rounded-2xl bg-white p-8 shadow-2xl">
            ...
            <div class="mb-6 flex justify-end">
                <a href="<?= e(base_url('forgot_password.php')) ?>" class="text-sm font-medium text-[#1a3a6b] hover:underline">¿Olvidaste tu contraseña?</a>
            </div>
